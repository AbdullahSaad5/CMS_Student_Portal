...
public class UpdateProfileTeacher implements MouseListener {
	...
	public UpdateProfileTeacher() {
		...
		homeButton = new JButton("Update Qualification");
		homeButton.setBounds(100, 453, 250, 29);
		...
		busButton = new JButton("Update Experience");

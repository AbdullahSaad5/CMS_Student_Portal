...
public class Utilities {
	...
	public static boolean checkRegistrationNumber(String message) {
		...
		String[] departments = { "BAF", "BAR", "BBA", "BCE", "BCS", "BDE", "BEC", "BEE", "BEL", "BET", "BFA", "BPH",
				"BPY", "BSE", "BSI", "BSM", "BSO", "BTN", "ECE", "EEE", "EPE", "MBA", "PBM", "PBS", "PCE", "PCH", "PCS",
				"PEE", "PME", "PMG", "PMI", "PMS", "PMT", "PPH", "PPH", "R06", "RBA", "RBI", "RBM", "RBS", "RCE", "RCS",
				"REC", "REE", "REL", "RHI", "RIR", "RIS", "RME", "RMG", "RMI", "RMS", "RMT", "RMV", "RPH" };
